...
var apiUrl = void 0;
var apiUrls = {
  production: 'https://simpl-to-do.herokuapp.com',
...
var addNestedValue = __webpack_require__(16);
...
var learnMoreTemplate = __webpack_require__(17);
var passwordFormTemplate = __webpack_require__(34);
var signInTemplate = __webpack_require__(35);
var signUpTemplate = __webpack_require__(36);
...
var showPasswordForm = function showPasswordForm() {
  $('#passwordModal').on('shown.bs.modal', function () {
    var passwordFormHtml = passwordFormTemplate();
    $('#passwordTemplate').append(passwordFormHtml);
  });
};

var showLearnMore = function showLearnMore() {
  $('#learnModal').on('shown.bs.modal', function () {
    var learnMoreHtml = learnMoreTemplate();
    $('#learnTemplate').append(learnMoreHtml);
  });
};

var showSignIn = function showSignIn() {
  var signInHtml = signInTemplate();
  clear();
  $('#signUpSection').hide();
  $('#signInTemplate').html(' ');
...
var changePasswordSuccess = function changePasswordSuccess(data) {
  var message = 'Your new password has been saved.';
  $('form').trigger('reset');
...
var store = __webpack_require__(3);
var todoTemplate = __webpack_require__(37);
var todoListTemplate = __webpack_require__(38);

var appError = function appError() {
  clear();
  error();
  showAlert();
};
...
var onHiddenModal = function onHiddenModal() {
  $('.modal').on('hidden.bs.modal', function (e) {
    clear();
  });
};
...
var onCreateSuccess = function onCreateSuccess() {
  return $('#createModal').modal('hide');
};

var onShowAllSuccess = function onShowAllSuccess(data) {
  var showTodoListHtml = todoListTemplate({ todos: data.todos });
  store.data = data;
  clearList();
  $('#list').append(showTodoListHtml);
};

var onShowAllFailure = function onShowAllFailure() {
  var message = 'Your list is empty. Create a to-do.';
  clearList();
  $('#list').append(message);
};

var onShowSuccess = function onShowSuccess(data) {
  var todoHtml = todoTemplate({ todo: data.todo });
  $('#todoTemplate').html(' ');
...
module.exports = {
  ...
  onShowAllSuccess: onShowAllSuccess,
  onShowAllFailure: onShowAllFailure,
...
var todosEvents = __webpack_require__(39);
...
var todosAPI = __webpack_require__(9);
var todosUI = __webpack_require__(10);

var onShowAll = function onShowAll() {
  todosAPI.index().then(todosUI.onShowAllSuccess).catch(todosUI.onShowAllFailure);
};

var onSignUp = function onSignUp(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  api.signUp(data).then(ui.signUpSuccess).catch(ui.authError);
};
...
var onSignOut = function onSignOut(event) {
  event.preventDefault();
  api.signOut().then(ui.signOutSuccess).catch(ui.authError);
};
...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<section>\n  <p>\n    A to-do list is known as a list of things that are important for you to do.\n  </p>\n  <p>\n    This is an application for users to create, update, read and delete their to-do list items on their browser.\n  </p>\n</section>\n<section>\n  <h4 class=\"text-uppercase text-mono text-strong\">How to Use</h4>\n  <p>\n    When a user creates a to-do, their to-do list will only be visible to them. After a user signs out of their account, they can view their saved to-do list by signing in again.\n  </p>\n  <article class=\"learn-article\">\n    <span class=\"text-strong btn btn-sm btn-default btn-custom\">Sign Up</span> <br>\n    <p>\n      If you are a new user, you can create a free account by signing up with your chosen email and password.\n    </p>\n  </article>\n  <article class=\"learn-article\">\n    <span class=\"text-strong btn btn-sm btn-default btn-custom\">Sign In</span> <br>\n    <p>\n      Sign in with your account’s email and password to continue.\n    </p>\n  </article>\n  <article class=\"learn-article\">\n    <span class=\"text-strong btn btn-sm btn-default btn-custom\">Password</span> <br>\n    <p>\n      Change your password by clicking on the <em>Change Password</em> button.\n    </p>\n    <p>\n      Type your current and new password and save your changes.\n    </p>\n  </article>\n  <article class=\"learn-article\">\n    <span class=\"text-strong btn btn-sm btn-default btn-custom\">Sign Out</span> <br>\n    <p>\n      Sign out by clicking on the <em>Sign Out</em> button.\n    </p>\n  </article>\n  <article class=\"learn-article\">\n    <span class=\"text-mono text-strong btn btn-sm btn-default btn-custom create\">\n      Create a To-Do\n    </span> <br>\n    <p>\n      Add something to your to-do list by clicking on the <em>Create</em> button.\n    </p>\n    <p>\n      When you’ve successfully created a to-do, it will show up on your to-do list.\n    </p>\n  </article>\n  <article class=\"learn-article\">\n    <input type=\"checkbox\" disabled>\n    <input type=\"checkbox\" checked disabled>\n    <h5 class=\"text-uppercase text-mono text-strong\">Update</h5>\n    <p>\n      Update your to-do by clicking on it, then type your changes and save them.\n    </p>\n    <p>\n      Mark a to-do list item as <em>done</em> by clicking on its checkbox. You can undo this action by clicking on the checkbox again and leaving it unchecked.\n    </p>\n  </article>\n  <article class=\"learn-article\">\n    <span class=\"close btn btn-link btn-custom delete\"><span aria-hidden=\"true\">&times;</span></span> <br>\n    <h5 class=\"text-uppercase text-mono text-strong\">Delete</h5>\n    <p>\n      Delete your to-do list items by clicking on the <em>Delete</em> button shown above.\n    </p>\n  </article>\n</section>\n";
},"useData":true});
...
function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<form id=\"password\">\n  <div class=\"form-group\">\n    <label for=\"inputPassword4\" class=\"control-label text-uppercase text-mono text-strong\">Current Password</label>\n    <input type=\"password\" id=\"inputPassword4\" class=\"form-control\" name=\"passwords[old]\" placeholder=\"Enter your current password\" required>\n  </div>\n  <div class=\"form-group\">\n    <label for=\"inputPassword5\" class=\"control-label text-uppercase text-mono text-strong\">New Password</label>\n    <input type=\"password\" id=\"inputPassword5\" class=\"form-control\" name=\"passwords[new]\" placeholder=\"Enter your new password\" required>\n  </div>\n  <div class=\"form-group text-right\">\n    <button type=\"submit\" class=\"text-strong btn btn-default btn-custom\" id=\"passwordButton\">Save</button>\n  </div>\n</form>\n";
},"useData":true});
...
function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<form class=\"form\" id=\"signIn\">\n  <div class=\"form-group\">\n    <label for=\"inputEmail2\" class=\"text-uppercase text-mono control-label\">Email</label>\n    <input type=\"email\" class=\"form-control\" id=\"inputEmail2\" name=\"credentials[email]\" placeholder=\"Enter your email address\" required>\n  </div>\n  <div class=\"form-group\">\n    <label for=\"inputPassword3\" class=\"text-uppercase text-mono control-label\">Password</label>\n    <input type=\"password\" class=\"form-control\" id=\"inputPassword3\" name=\"credentials[password]\" placeholder=\"Enter your password\" required>\n  </div>\n  <div class=\"form-group\">\n    <button type=\"submit\" class=\"text-strong btn btn-default btn-custom\">Sign In</button>\n  </div>\n</form>\n";
},"useData":true});
...
function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<form class=\"form\" id=\"signUp\">\n  <div class=\"form-group\">\n    <label for=\"inputEmail1\" class=\"text-uppercase text-mono control-label\">Email</label>\n    <input type=\"email\" class=\"form-control\" id=\"inputEmail1\" name=\"credentials[email]\" placeholder=\"Enter your email address\" required>\n  </div>\n  <div class=\"form-group\">\n    <label for=\"inputPassword1\" class=\"text-uppercase text-mono control-label\">Password</label>\n    <input type=\"password\" class=\"form-control\" id=\"inputPassword1\" name=\"credentials[password]\" placeholder=\"Enter your password\" required>\n  </div>\n  <div class=\"form-group\">\n    <label for=\"inputPassword2\" class=\"text-uppercase text-mono control-label\">Password Confirmation</label>\n    <input type=\"password\" class=\"form-control\" id=\"inputPassword2\" name=\"credentials[password_confirmation]\" placeholder=\"Confirm your password\" required>\n  </div>\n  <div class=\"form-group\">\n    <button type=\"submit\" class=\"text-strong btn btn-default btn-custom\">Sign Up</button>\n  </div>\n</form>\n";
},"useData":true});
...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<form class=\"form update update-content\">\n  <div class=\"form-group\">\n    <input type=\"text\" class=\"form-control input-sm to-do-content\"  name=\"todo[content]\" placeholder=\""
    + container.escapeExpression(container.lambda(((stack1 = (depth0 != null ? depth0.todo : depth0)) != null ? stack1.content : stack1), depth0))
    + "\">\n  </div>\n  <div class=\"form-group text-right\">\n    <button class=\"text-strong btn btn-default btn-sm btn-custom\" type=\"submit\">Save</button>\n  </div>\n  <p class=\"hidden message\"></p>\n</form>\n";
},"useData":true});
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
    return "<p>Your list is empty. Create a to-do.</p>\n";
},"3":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1, alias1=container.lambda, alias2=container.escapeExpression, alias3=depth0 != null ? depth0 : (container.nullContext || {});

  return "  <li class=\"to-do\">\n    <form class=\"form update update-done\">\n      <input type=\"hidden\" name=\"todo[content]\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.content : stack1), depth0))
    + "\" class=\"to-do-content\">\n"
    + ((stack1 = helpers["if"].call(alias3,((stack1 = blockParams[0][0]) != null ? stack1.done : stack1),{"name":"if","hash":{},"fn":container.program(4, data, 0, blockParams),"inverse":container.program(6, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "      <p class=\"hidden message\"></p>\n    </form>\n    <a role=\"button\" name=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.content : stack1), depth0))
    + "\" data-id="
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + " data-toggle=\"modal\" data-target=\"#todoModal\" class=\"btn btn-link btn-custom see-more\">\n"
    + ((stack1 = helpers["if"].call(alias3,((stack1 = blockParams[0][0]) != null ? stack1.done : stack1),{"name":"if","hash":{},"fn":container.program(8, data, 0, blockParams),"inverse":container.program(10, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "    </a>\n    <a role=\"button\" class=\"close btn btn-link btn-custom delete\">\n      <span data-id="
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + " aria-hidden=\"true\">&times;</span>\n    </a>\n  </li>\n";
},"4":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1, alias1=container.lambda, alias2=container.escapeExpression;

  return "      <input type=\"checkbox\" name=\"todo[done]\" aria-label=\"checkbox\" class=\"to-do-done\" value=\""
    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.done : stack1), depth0))
    + "\" data-id="
  ...
  return ((stack1 = helpers.unless.call(alias1,(depth0 != null ? depth0.todos : depth0),{"name":"unless","hash":{},"fn":container.program(1, data, 0, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "\n<ul class=\"list-unstyled to-do-list\" id=\"todoList\">\n"
    + ((stack1 = helpers.each.call(alias1,(depth0 != null ? depth0.todos : depth0),{"name":"each","hash":{},"fn":container.program(3, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "</ul>\n";
...
var createTemplate = __webpack_require__(40);
var getFormFields = __webpack_require__(6);
var store = __webpack_require__(3);
...
var onCreate = function onCreate(event) {
  ...
  var data = getFormFields(event.target);
  store.data = data;
  api.create(data).then(ui.onCreateSuccess).then(function () {
    return onShowAll();
  }).catch(ui.appError);
};
...
var onDelete = function onDelete(event) {
  ...
  api.destroy(id).then(function () {
    return onShowAll();
  }).catch(ui.appError);
};

var onShowAll = function onShowAll() {
  api.index().then(ui.onShowAllSuccess).catch(ui.onShowAllFailure);
};

var onShow = function onShow(event) {
  event.preventDefault();
  var id = event.target.dataset.id;
  api.show(id).then(ui.onShowSuccess).catch(ui.appError);
};

var onShownCreate = function onShownCreate() {
  $('#createModal').on('shown.bs.modal', function (event) {
    event.preventDefault();
    var createHtml = createTemplate();
    $('#createTemplate').html(' ');
...
var id = void 0;
var onShownUpdate = function onShownUpdate() {
...
var onUpdate = function onUpdate(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  api.update(data, id).then(ui.onUpdateSuccess).then(function () {
    return onShowAll();
  }).catch(ui.appError);
};

var onCheckboxToggle = function onCheckboxToggle(event) {
  event.target.value = event.target.checked;
  var content = $(event.target).siblings('.to-do-content').val();
  var done = event.target.value;
  var data = {
    todo: {
      content: content,
      done: done
...
function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<form class=\"form create\">\n  <div class=\"form-group\">\n    <input type=\"text\" class=\"form-control input-sm to-do-content\"  name=\"todo[content]\" placeholder=\"Type here\" required>\n  </div>\n  <div class=\"form-group text-right\">\n    <button class=\"text-strong btn btn-default btn-sm btn-custom\" type=\"submit\">Create</button>\n  </div>\n  <p class=\"hidden message\"></p>\n</form>\n";
},"useData":true});
